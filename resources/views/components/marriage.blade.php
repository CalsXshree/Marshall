{{-- <div>
    <div class="relative overflow-hidden w-full h-[20rem] bg-red-600 border border-green-600 ">
        <img src="{{ asset('images/marshall(31).jpg') }}" class="object-fill" alt="">
...
<div>
    <div class=" relative w-full h-[31rem] overflow-hidden bg-no-repeat bg-cover bg-fixed"
        ...
        <div class="w-full h-full grid place-items-center">
            <div class=" relative text-3xl top-24 text-white font-serif z-20">
                YOU DESERVE WEDDING PHOTOS THAT CELEBRATE <br> ONE OF THE MOST SPECIAL DAYS OF YOUR LIFE
                <center>
                    <div class="h-[2px] w-1/2 bg-amber-100 mb-5 z-20 relative ">
                </center>
            </div>
            <div class="text-2xl font-serif text-white">
